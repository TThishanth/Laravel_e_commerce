...
<head>
    ...
    <link href="{{ asset('home/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('home/plugins/slick-1.8.0/slick.css') }}">
...
<body>
                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img src="{{ asset('home/images/phone.png') }}" alt=""></div>
                                +38 068 005 3570
                            </div>
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img src="{{ asset('home/images/mail.png') }}" alt=""></div><a
                            ...
                            <div class="top_bar_content ml-auto">
                                ...
                                <div class="top_bar_user">
                                    ...
                                    <div class="user_icon"><img src="{{ asset('home/images/user.svg') }}" alt=""></div>
                                    @if (Route::has('login'))
                                    ...
                                    <div class="header_search_form_container">
                                        <form action="#" class="header_search_form clearfix">
                                            ...
                                            <button type="submit" class="header_search_button trans_300"
                                                value="Submit"><img src="{{ asset('home/images/search.png') }}"
                                                    alt=""></button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="menu_contact">
                                    <div class="menu_contact_item">
                                        <div class="menu_contact_icon"><img
                                                src="{{ asset('home/images/phone_white.png') }}" alt=""></div>
                                        +38 068 005 3570
                                    </div>
                                    <div class="menu_contact_item">
                                        <div class="menu_contact_icon"><img
                                                src="{{ asset('home/images/mail_white.png') }}" alt=""></div><a
                                            href="mailto:fastsales@gmail.com">fastsales@gmail.com</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="banner">
                ...
                <div class="container fill_height">
                    <div class="row fill_height">
                        <div class="banner_product_image"><img src="{{ asset('home/images/banner_product.png') }}"
                                alt="">
                        </div>
                    ...
                    <div class="col">
                        <div
                            ...
                            <div class="newsletter_title_container">
                                <div class="newsletter_icon"><img src="{{ asset('home/images/send.png') }}" alt="">
                                </div>
                    ...
                    <div class="col">
                        ...
                        <div
                            ...
                            <div class="logos ml-sm-auto">
                                <ul class="logos_list">
                                    <li><a href="#"><img src="{{ asset('home/images/logos_1.png') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('home/images/logos_2.png') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('home/images/logos_3.png') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('home/images/logos_4.png') }}" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('home/plugins/slick-1.8.0/slick.js') }}"></script>
